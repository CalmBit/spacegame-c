...
void audio_reverb_set_gain(audio_reverb_t* reverb, ALfloat gain) {
    _audio_reverb_setf(reverb, &reverb->gain, gain, 0.0f, 1.0f, "gain", 
                        AL_REVERB_GAIN);
}

void audio_reverb_set_decay(audio_reverb_t* reverb, ALfloat decay) {
    _audio_reverb_setf(reverb, &reverb->decay, decay, 0.0f, 20.0f, "decay", 
...
void audio_reverb_set_rdelay(audio_reverb_t* reverb, ALfloat rdelay) {
    _audio_reverb_setf(reverb, &reverb->reflection_gain, rdelay, 0.0f, 0.3f, 
